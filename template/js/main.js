...
(function ($) {
  ...
  $(".hero__search__categories__all").on("click", function () {
  ...
  proQty.on("click", ".qtybtn", function () {
    ...
    var newVal = button.siblings("input");
    if (button.hasClass("inc")) {
      ...
      if (oldValue > 0) {
        newVal.val(oldValue - 1);
      } else {
        newVal.val(0);
      }
    }
    
    if (button.siblings("input").hasClass("cartInput")) {
      var price = $(this)
        .parent()
        .parent()
        .parent()
