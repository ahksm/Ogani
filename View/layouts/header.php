                    ...
                    <div class="hero__categories">
                        ...
                        <ul>
                            <? foreach ($this->departments as $department) : ?>
                                <li class="<? if ($this->departmentId == $department['id']) echo 'active'; ?>"><a href="/shop/<?= $department['category_id']; ?>/department-<?= $department['id']; ?>"><?= $department['name']; ?></a></li>
                            <? endforeach; ?>
                        </ul>
                    </div>
                </div>
                                ...
                                <div class="hero__search__categories hero-normal">
                                    ...
                                    <ul>
                                        <? foreach ($this->categories as $category) : ?>
                                            <li class="<? if ($this->categoryId == $category['id']) echo 'active'; ?>">
